...
class McpService {
  ...
  async executeTool(serverId: string, toolName: string, args: any) {
    ...
    console.log(`[MCP Request] Сервер: ${serverName}, Инструмент: ${toolName}`)
    console.log(`[MCP Request] Аргументы:`, args)
    ...
    console.log(`[MCP Response] Сервер: ${serverName}, Инструмент: ${toolName}`)
    console.log(`[MCP Response] Результат:`, result)
